...
import com.video.ijkplayer.listener.OnPlayOperationListener;
import com.video.ijkplayer.listener.OnVideoViewStateChangeListener;
import com.video.ijkplayer.util.PlayerUtils;
import com.video.ijkplayer.widget.ResizeSurfaceView;
import com.video.ijkplayer.widget.ResizeTextureView;
...
public class IjkVideoView extends BaseIjkVideoView {
    ...
    private OnPlayOperationListener operationListener;
...
//        LogUtils.d("currentPlayerState", "状态--->" + mCurrentPlayState);
////        if(mCurrentPlayState==STATE_PLAYING&&checkNetwork()){
////            startPlay();
////
////        }
...
//    }
    ...
    private void addTextureView() {
        ...
        mTextureView.setSurfaceTextureListener(new TextureView.SurfaceTextureListener() {
            ...
            public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int width, int height) {
                ...
                } else if (surfaceTexture != null && mMediaPlayer != null) {
    ...
    public void setOperationListener(OnPlayOperationListener operationListener) {
