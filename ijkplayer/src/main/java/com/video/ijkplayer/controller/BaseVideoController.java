package com.video.ijkplayer.controller;
...
import com.video.ijkplayer.player.BaseIjkVideoView;
import com.video.ijkplayer.player.IjkVideoView;
import com.video.ijkplayer.util.PlayerUtils;
import com.video.ijkplayer.widget.StatusView;
...
public abstract class BaseVideoController extends FrameLayout {
    ...
    public void showStatusView() {
        ...
        if(videoSize==null){
            ...
            mStatusView.setMessage(getResources().getString(R.string.play_consume_tip)+videoSize);
        }
